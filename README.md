...
<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=22&pause=1000&color=58A6FF&center=true&vCenter=true&width=600&lines=Quality+Assurance;Testes+Funcionais;API+Testing;Postman;Sempre+evoluindo+%F0%9F%9A%80" />
<br>
</div>
...
Sou profissional em desenvolvimento na área de QA, transformando aprendizado em prática através de projetos reais.

🔎 Testes Funcionais • 🐞 Bugs • 🔄 Regressão • 💨 Smoke Testing • 📮 APIs • 🚀 Postman
...
Testes funcionais, cenários, execução de casos e identificação de bugs.
...
Validação de campos, cenários positivos/negativos e regras de negócio.
...
Validação de API, requisições, respostas e status codes com Postman.
